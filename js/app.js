...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    div.innerHTML = `<div class="single-product m-3 ">
      <div>
    <img class="product-image" src=${image}></img>
      ...
      <button onclick="addToCart(${product.id},${product.price})" id="addToCart-btn" style="background-color: rgb(110, 173, 231);" class="buy-now btn border-dark">Add to cart</button>
